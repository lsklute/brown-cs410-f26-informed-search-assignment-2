...
from typing import Generic, Hashable, TypeVar, Set
...
class SearchProblem(ABC, Generic[State]):
    """
    Abstract base class defining a search problem: an initial state, a goal
    test, and a way to generate successor states. SearchProblem carries no
    search statistics -- those live on SearchSolution (see search_solution.py),
    which a SearchAlgorithm produces by searching a SearchProblem.
    """
