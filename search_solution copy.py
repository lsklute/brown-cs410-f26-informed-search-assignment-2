...
class SearchSolution(Generic[State]):
    ...
    search_algorithm.py), not here.
    """

    def __init__(self, problem: SearchProblem[State], path: Optional[List[State]] = None) -> None:
    ...
    def __repr__(self) -> str:
        return f"SearchSolution(path_length={self.path_length()}, {self.stats})"
